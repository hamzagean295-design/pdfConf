    ...
    <div class="container mx-auto p-4">
        ...
        <div class="bg-white shadow-md rounded-lg p-6 mb-4">
            ...
            <div class="flex items-center justify-between mt-6">
                <a href="{{ route('facture.edit', $facture) }}" class="bg-yellow-500 hover:bg-yellow-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">
                    Éditer
                </a>
        ...
        @if ($facture->document_path)
            <div class="mt-6">
                <a href="{{ $facture->documentUrl() }}" target="_blank" class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">
                    voir le pdf
                </a>
            </div>
        @endif
